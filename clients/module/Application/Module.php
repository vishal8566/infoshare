    ...
    public function getServiceConfig() {
        return array(
            ...
            return $table;
                ...
                'Application\Service\Loan' => function($sm) {
            $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
            $table = new \Application\Service\Loan($dbAdapter);
            return $table;
        },
                'Application\Service\Search' => function($sm) {
            $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
            $table = new \Application\Service\Search($dbAdapter);
            return $table;
        },
                'Application\Service\Support' => function($sm) {
            $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
            $table = new \Application\Service\Support($dbAdapter);
            return $table;
        },
            ...
            return $table;
                ...
                'Application\Service\Users' => function($sm) {
            $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
            $table = new \Application\Service\Test($dbAdapter);
            return $table;
        }
            )
        );
